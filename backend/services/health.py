...
class HealthMonitor:
    ...
    async def get_health_status(self):
        ...
        connections = await connection_manager.get_all_statuses()
        return {
            "status": "ok",
            ...
            "google_sheets_configured": bool(env_settings.google_sheet_id and env_settings.google_sheets_credentials_b64),
